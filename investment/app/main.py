...
investments = {
    "stock": Investment(name="Stock", amount=1000.0, expected_return=0.1, risk_level="Medium"),
    "bond": Investment(name="Bond", amount=500.0, expected_return=0.05, risk_level="Low"),
